# Summary week 5
The repository for exercise E of the 1-docker folder in the MADS-Deployment repository can be found on [**Exercise E**](https://github.com/mwienhoven/Minimal-Docker-Example-Marcello-Wienhoven). Running:
```bash
make all 
```
